                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                        	 <h3 class="content">칼로리 정보 등록 화면</h3>
								<form action="${pageContext.request.contextPath}/mypage/cbBoardEnd.do" method="post">
										<table id="updateCal">
										<input type="hidden" id="cb_mno" name="cb_mno" value="${member.m_No }" />
											<tr>
												<th>음식명</th>
											...
											<tr>
												<th>단위</th>
												<td><input type="text" class="form-control" id="cb_foodname" name="cb_unit" required></td>
											</tr>
											<tr>
												<th>칼로리</th>
												<td><input type="text" class="form-control" id="cb_unit" name="cb_cal"required></td>
											</tr>
											<tr>
												<th>탄수화물</th>
												<td><input type="text" class="form-control" id="cb_cal" name="cb_carbohydrate"required></td>
											</tr>
											<tr>
												<th>단백질</th>
												<td><input type="text" class="form-control" id="cb_carbohydrate" name="cb_protein" required></td>
											</tr>
											<tr>
												<th>지방</th>
