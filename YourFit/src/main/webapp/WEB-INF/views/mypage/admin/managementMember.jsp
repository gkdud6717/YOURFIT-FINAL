                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                        	<div class="content title-group">
                        		<div class="title1">
	                        		<h2 style="margin: 0px; padding:0px;"><a href="${pageContext.request.contextPath}/mypage/Member.do">
	                        											  <i class="fa fa-user" style="margin-right: 10px"></i></a>회원 관리</h2>
								</div>
								<div class="title2">
	                        		<h3 style="margin: 0px; padding:0px;">Today's Join : ${todayJoinMember }</h3>
								</div>
							</div>
