                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                        	...
                        	<div class="category-group">
                        		...
                        		<div class="category-group category3 category-actice" onclick="go_Y();">접수 완료</div>
                        		<div class="category-group category4"><span class="color-red">${totalContents}건</span>의 주문 완료되었습니다.</div>
                        	</div>
