                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                        	<div class="content">
	                        	<h2 class="content-title"><a href="${pageContext.request.contextPath}/mypage/sale.do">
	                        	<i class="fa fa-shopping-cart"></a></i> 주문 관리</h2>
                        	</div>
                        	
                        	<div class="category-group">
                        		<div class="category-group category1 category-actice" onclick="go_all();">전체</div>
                        		<div class="category-group category2" onclick="go_N();">접수 미완료</div>
                        		<div class="category-group category3" onclick="go_Y();">접수 완료</div>
                        		<div class="category-group category4">
                        			총 주문 : <span class="color-red">${totalContents}건</span>
                        			접수 미완료 : ${totalContentsN }건 
                        			접수 완료 : ${totalContentsY }건
                        		</div>
                        	</div>
