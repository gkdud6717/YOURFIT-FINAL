                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                        	<div class="title-group">
	                        	<h2 class="content content-title"><i class="fa fa-info-circle" style="margin-right: 10px"></i>광고 관리</h2>
							            ...
							            <div class="row">
							              ...
							              <c:forEach items="${list}" var="adboard"> 
								               <div class="pcard">
								                  <div class="col">
								                        <div class="card">
								                            <a onclick="pop_move('${adboard.ad_No}');">
								                            ...
								                            <div class="card-body">
								                            	...
								                            	<h5 class="card-title font-bold">${adboard.ad_Date}</h5>
								                                	<select class="status" name="status" id="${adboard.ad_No}">
																		<option value="Y" ${adboard.status=='Y'?'selected':'' }>활성화</option>
																		<option value="N" ${adboard.status=='N'?'selected':'' } style="color: red;">비활성화</option>			
