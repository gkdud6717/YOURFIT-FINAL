                                    ...
                                    <div class="col-md-5">
                                        <div class="post-media">
                                            <a href="${pageContext.request.contextPath}/dtboard/dtBoardView.do?no=${b.dt_No}" title="">
                                                ...
                                                <img src="${pageContext.request.contextPath}/resources/dtboardUpload/${b.files[0].f_Cname}" id="img_dt" style="width:445px; height:296px;">
                                              </c:if>
											  <c:if test="${ empty b.files }">
                                     ...
                                     <div class="col-md-7">
                                       ...
                                       <div id="con_box">
                                         <p class="contentbox" ><a href="${pageContext.request.contextPath}/dtboard/dtBoardView.do?no=${b.dt_No}" title="">${b.dt_Content}</a></p>                                    
                                       </div>
